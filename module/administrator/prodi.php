...
require 'view.php';
$roles = 'user';
$query = tampildata("SELECT * FROM prodi");
?>
<!DOCTYPE html>
<html lang="en">
                              ...
                              <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                 <thead>
                                    <tr>
                                       ...
                                       <th>Kode Prodi</th>
                                       <th class="col-6">Program Studi</th>
                                       <th>Status</th>
                                 ...
                                 <tbody>
                                    ...
                                    <?php foreach ($query as $row) : ?>
                                       <tr>
                                          ...
                                          $data_fk = mysqli_query($koneksi, "SELECT * FROM fakultas WHERE kode_fakultas='$kode'");
                                          $info_fk = mysqli_fetch_array($data_fk);
                                          ?>
                                          <td><?= $info_fk['fakultas'] ?></td>
               ...
               <div class="modal-body">
                  <div class="form-group">
                     ...
                     <select data-toggle="select2" title="Country" required name="negara">
                        <option value="">Cari Fakultas</option>
                        <?php
                        $query = tampildata("SELECT * FROM fakultas WHERE status=1");
                        ?>
                        <?php foreach ($query as $data) : ?>
                           <option value="<?= $data['kode_fakultas'] ?>"><?= $data['fakultas'] ?></option>
                        <?php endforeach ?>
                     </select>
                  </div>
                  <div class="form-group">
                     <label for="example-email">Kode Program Studi</label>
                     <input type="text" id="example-email" name="example-email" class="form-control">
                  </div>
                  <div class="form-group">
                     <label for="example-pass">Program Studi</label>
