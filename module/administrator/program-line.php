<?php
$page = 'Program Jalur Masuk';
require 'view.php';
$roles = 'user';
$query = tampildata("SELECT * FROM program_line");
?>
<!DOCTYPE html>
<html lang="en">
                                 ...
                                 <tbody>
                                    ...
                                    <?php foreach ($query as $row) : ?>
                                       <tr>
                                          ...
                                          $data_fk = mysqli_query($koneksi, "SELECT * FROM program WHERE kode_program='$kode'");
                                          $info_fk = mysqli_fetch_array($data_fk);
                                          ?>
                                          <td><?= $info_fk['program'] ?></td>
                                          <td><?= $row['kode_jalur'] ?></td>
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="form-group">
                     <label for="example-email">Kode Program</label>
                     <input type="text" id="example-email" name="example-email" class="form-control">
                  </div>
                  <div class="form-group">
                     <label for="example-pass">Program</label>
