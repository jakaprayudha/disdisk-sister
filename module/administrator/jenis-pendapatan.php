<?php
$page = 'Jenis Pendapatan';
require 'view.php';
$query = tampildata("SELECT * FROM jenis_pendapatan");
?>
<!DOCTYPE html>
<html lang="en">
                              ...
                              <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                 <thead>
                                    <tr>
                                       <th>No</th>
                                       <th>Kode Rekening</th>
                                       <th class="col-8">Jenis Pendapatan</th>
                                       <th>Status</th>
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="form-group">
                     <label for="example-email">Kode Rekening</label>
                     <input type="text" id="example-email" name="example-email" class="form-control">
                  </div>
                  <div class="form-group">
                     <label for="example-pass">Jenis Pendapatan</label>
