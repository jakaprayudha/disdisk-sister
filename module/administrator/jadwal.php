...
require 'view.php';
$roles = 'user';
$query = tampildata("SELECT * FROM program_aktivitas");
?>
<!DOCTYPE html>
<html lang="en">
                                 ...
                                 <tbody>
                                    ...
                                    <?php foreach ($query as $row) : ?>
                                       <tr>
                                          ...
                                          $kode = $row['kode_jalur'];
                                          $data_fk = mysqli_query($koneksi, "SELECT * FROM program_line WHERE kode_jalur='$kode'");
                                          $info_fk = mysqli_fetch_array($data_fk);
                                          ?>
                                          <td><?= $info_fk['jalur_masuk'] ?></td>
                                          <td><?= $row['kode'] ?></td>
                                          <td><?= $row['aktivitas'] ?></td>
                                          <td>
                                             <?php
