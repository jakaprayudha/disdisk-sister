<?php
$page = 'User Universitas';
require 'view.php';
$roles = 'user';
$query = tampildata("SELECT * FROM user WHERE roles!='$roles'");
?>
<!DOCTYPE html>
<html lang="en">
               ...
               <div class="modal-body">
                  <div class="form-group">
                     ...
                     <select data-toggle="select2" title="Country" required name="negara">
                        ...
                        <?php
                        $query = tampildata("SELECT * FROM pegawai WHERE status=1");
                        ?>
                  ...
                  <div class="form-group">
                     <label for="example-email">Module</label>
                  ...
                  <div class="form-group">
                     <label for="example-email">Roles</label>
                  ...
                  <div class="form-group">
                     <label for="example-pass">Password</label>
                     <input type="text" id="example-pass" name="example-pass" class="form-control" value="<?= rand(1111, 9999) ?>">
                  </div>
