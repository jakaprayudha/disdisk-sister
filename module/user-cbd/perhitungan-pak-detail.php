                        ...
                        <div class="card-body">
                           <div class="row mb-2">
                              ...
                              <div class="col-sm-8">
                                 <div class="text-sm-right">
                                    <button type="button" class="btn btn-light mb-2">Kembali</button>
                                 </div>
                              </div><!-- end col-->
                           </div>
                           <div class="table-responsive">
                              <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                 <thead>
                                    <tr>
                                       <th colspan="2">Angka Kredit Konvensional</th>
                                       <th colspan="2">Angka Kredit Integritas</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    <tr>
                                       <th>Pendidikan</th>
                                       <td><?= number_format(23000) ?></td>
                                       <th>Tugas Jabatan</th>
                                       <td><?= number_format(288990) ?></td>
                                    </tr>
                                    <tr>
                                       <th>Tugas Pokok</th>
                                       <td><?= number_format(413202) ?></td>
                                    </tr>
                                    <tr>
                                       <th>Pengembangan Profesi</th>
                                       <td><?= number_format(12000) ?></td>
                                       <th>Pengembangan Profesi</th>
                                       <td><?= number_format(0) ?></td>
                                    </tr>
                                    <tr>
                                       <th>Unsur Penunjang</th>
                                       <td><?= number_format(90288) ?></td>
                                       <th>Unsur Penunjang</th>
                                       <td><?= number_format(0) ?></td>
                                    </tr>
                                    <tr>
                                       <th>Jumlah</th>
                                       <td><?= number_format(700990) ?></td>
                                       <th>Jumlah</th>
                                       <td><?= number_format(300990) ?></td>
                                    </tr>
                                 </tbody>
                              </table>
                           </div>
