...
require '../../controller/profile/controllerJafung.php';
$roles = 'user';
$query = tampildata("SELECT * FROM jafung WHERE nik='$nik'");
?>
<!DOCTYPE html>
<html lang="en">
                                             ...
                                             <div class="modal-content">
                                                ...
                                                <form action="" method="POST" enctype="multipart/form-data">
                                                   ...
                                                   <div class=" modal-footer">
                                                      ...
                                                      <button type="submit" name="upload-jafung" class="btn btn-primary">Simpan</button>
                                                   </div>
                                                </form>
                                             </div><!-- /.modal-content -->
                                          </div><!-- /.modal-dialog -->
                                                ...
                                                <div class="modal-body p-4">
                                                   <form action="" method="POST">
                                                      ...
                                                      <div class="text-center">
                                                         ...
                                                         <button type="submit" name="proses-jafung" class="btn btn-light my-2">Ya, Hapus</button>
                                                      </div>
                                                   </form>
                                                </div>
                                             </div><!-- /.modal-content -->
               ...
               <form action="" method="POST">
                  ...
                  <div class="modal-body">
                     <div class="form-group">
                        ...
                        <select name="jabatan" class="form-control" id="jabatan" require>
                           <option value="">PILIH</option>
                           <?php
                           $getJafung = mysqli_query($koneksi, "SELECT * FROM jabatan ");
                           ?>
                           <?php foreach ($getJafung as $dataJafung) : ?>
                              <option value="<?= $dataJafung['jabatan'] ?>"><?= $dataJafung['jabatan'] ?></option>
                           <?php endforeach ?>
                        </select>
                     </div>
                     <div class="form-group">
                        <label for="nomor_sk">Nomor SK</label>
                        <input type="text" required id="nomor_sk" name="nomor_sk" class="form-control">
                     </div>
                     <div class="form-group">
                        <label for="terhitung_mulai">Terhitung Mulai</label>
                        <input type="date" required id="terhitung_mulai" name="terhitung_mulai" class="form-control">
                     </div>

                  </div>
                  <div class=" modal-footer">
                     <button type="button" class="btn btn-light" data-dismiss="modal">Batal</button>
                     <button type="submit" name="proses-jafung" class="btn btn-primary">Simpan</button>
                  </div>
               </form>
            </div><!-- /.modal-content -->
         </div><!-- /.modal-dialog -->
