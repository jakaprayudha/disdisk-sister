                           ...
                           <div class="table-responsive">
                              <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                 <thead>
                                    <tr>
                                       <th>No</th>
                                       <th class="text-center">Jumlah Angka Kredit Diperoleh</th>
                                       <th class="text-center">Nilai Dasar</th>
                                       <th class="text-center">Angka Kredit Penilaian Integrasi</th>
                                 ...
                                 <tbody>
                                    <tr>
                                       <td>1</td>
                                       <td class="text-center"><?= number_format(700990) ?></td>
                                       <td class="text-center"><?= number_format(400000) ?></td>
                                       <td class="text-center"><?= number_format(700990 - 400000) ?></td>
                                       <td class="text-center">
                                          <span class="badge badge-success">Terpenuhi</span>
                                       </td>
                                       <td class="text-center">
                                          <a href="module/user/perhitungan-pak-detail">
