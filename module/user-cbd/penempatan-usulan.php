                  ...
                  <div class="col-12">
                     <div class="card">
                        <div class="card-body">
                           <div class="row mb-2">
                              <div class="col-sm-4">
                                 <a href="module/user/penempatan" class="btn btn-light mb-2"><i class="mdi mdi-arrow-left mr-2"></i> Kembali</a>
                              </div>
                              <div class="col-sm-8">
                                 <div class="text-sm-right">
                                    <button type="button" class="btn btn-outline-primary mb-2">Draft</button>
                                    <button type="button" class="btn btn-outline-primary mb-2">Diajukan</button>
                                    <button type="button" class="btn btn-outline-primary mb-2">Perlu Tindakan</button>
                                    <button type="button" class="btn btn-outline-primary mb-2">Selesai Diperiksa</button>
                                    <button type="button" class="btn btn-outline-primary mb-2">Disetujui Pusat</button>
                                    <button type="button" class="btn btn-outline-primary mb-2">Ditolak</button>
                                 </div>
                              </div><!-- end col-->
                           </div>
