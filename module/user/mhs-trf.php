               ...
               <div class="row">
                  <div class="col-12">
                     <div class="page-title-box">
                        ...
                        <h4 class="page-title">Program Mahasiswa Konversi</h4>
                     </div>
                  </div>
               </div>
               <!-- end page title -->
                           ...
                           <form action="" method="POST">
                              ...
                              <div class="tab-content">
                                 ...
                                 <div class="tab-pane show active" id="billing-information">
                                    <div class="row">
                                       <div class="col-lg-12">
                                          <h4 class="mt-2">Data Akademik Kampus</h4>
                                          <p class="text-muted mb-4">Isi data akademik kampus sebelumnya anda</p>
                                          <div class="row">
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                   <label for="nama">Nama Kampus Asal <span class="text-danger">*</span></label>
                                             ...
                                             <div class="col-md-3">
                                                <div class="form-group">
                                                   <label for="jurusan">Jurusan / Prodi <span class="text-danger">*</span></label>
                                             ...
                                             <div class="col-md-3">
                                                <div class="form-group">
                                                   <label for="sks">Total SKS Ditempuh <span class="text-danger">*</span></label>
                                                   <input type="number" class="form-control" required name="sks" id="sks">
                                                </div>
                                             </div>
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                   <label for="khs">Upload KHS/KRS Terakhir<span class="text-danger">*</span></label>
