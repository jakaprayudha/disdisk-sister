         ...
         <div class="content">
            ...
            <div class="container-fluid">
               ...
               <div class="row">
                  <div class="col-12">
                     <div class="alert alert-primary" role="alert">
                        <strong></strong>
                        Jika terdapat ketidaksesuaian dalam hasil integrasi, silakan melapor dan bersurat kepada pihak terkait sesuai dengan jabatan fungsional Anda, yaitu:
                        <ul>
                           <li> Guru PTN dengan jabatan AA dan Lektor mohon bersurat kepada Perguruan Tinggi masing-masing,</li>
                           <li> Guru PTN dengan jabatan LK dan GB mohon bersurat ke Kemendikbudristek,</li>
                           <li> Guru PTS mohon bersurat ke LLDikti setempat.</li>
                        </ul>
                     </div>
                     ...
                     <div class="card">
                        <div class="card-body">
                           <div class="alert alert-primary bg-white text-primary" role="alert">
                              <strong>
                                 Informasi Hasil Integrasi AK
                              </strong>
                              <p>
                                 Berikut adalah informasi hasil integrasi Angka Kredit yang Anda dapatkan
                              </p>
                              <div class="form-group row mb-1 text-dark">
                                 <label for="inputEmail3" class="col-3 col-form-label">AK Integrasi</label>
                                 <div class="col-9">
                                    <input type="text" readonly class="form-control-plaintext" id="example-static" value="-">
                                 </div>
                              </div>
                              <div class="form-group row mb-1 text-dark">
                                 <label for="inputEmail3" class="col-3 col-form-label">Kelompok sesuai Peraturan Kepala BKN No. 3 Tahun 2023</label>
                                 <div class="col-9">
                                    <input type="text" readonly class="form-control-plaintext" id="example-static" value="-">
                                 </div>
                              </div>
                           ...
                           <div class="row mb-2">
                              ...
                              <div class="col-sm-8">
                                 <div class="text-sm-right">
                                    ...
                                    <button type="button" class="btn btn-light mb-2">Lihat Ketentuan SE</button>
                                 </div>
                              </div><!-- end col-->
                           </div>
                              ...
                              <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                 <thead>
                                    <tr>
                                       ...
                                       <th>Sekolah</th>
                                       <th>AK Integrasi</th>
                                       <th>Kelompok BKN No.3 Thaun 2023</th>
                                       <th>AK Pengembgan Profesi</th>
                                       <th>AK Kegiatan Penunjang</th>
                                       <th>AK Tugas</th>
               ...
               <div class="alert alert-danger" role="alert">
                  <strong> Angka Kredit</strong> Anda belum terintegrasi. Silakan hubungi operator terkait untuk progres integrasi.
               </div>
               <!-- end row -->
