               ...
               <div class="row">
                  <div class="col-12">
                     <div class="page-title-box">
                        ...
                        <h4 class="page-title">Program Mahasiswa Baru</h4>
                     </div>
                  </div>
               </div>
               <!-- end page title -->
                           ...
                           <form action="" method="POST">
                              ...
                              <div class="tab-content">
                                 ...
                                 <div class="tab-pane show active" id="billing-information">
                                    <div class="row">
                                       <div class="col-lg-12">
                                          <h4 class="mt-2">Program Studi</h4>

                                          <p class="text-muted mb-4">Isi data fakultas dan program studi yang anda ingingkan</p>
                                          <div class="row">
                                             <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                   ...
                                                   <select name="prodi" required class="form-control" id="prodi">
                                    ...
                                    <div class="row">
                                       <div class="col-sm-12">
                                          <div class="text-sm-left">
                                             <button class="btn btn-danger" type="submit" name="program_baru"> Simpan</button>
                                          </div>
                                       </div>
                                    </div> <!-- end row-->
                                 </div>
