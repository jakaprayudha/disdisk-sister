               ...
               <div class="row">
                  <div class="col-12">
                     <div class="alert alert-primary" role="alert">
                        Info:Layanan ini mulai digunakan pada Semester Genap Tahun Ajaran 2020/2021
                        <ul>
                           <li>
                              Salinan PO BKD 2021 <span class="badge badge-primary">Download</span>
                           </li>
                           <li>
                              Pengantar terbit PO BKD 2021 <span class="badge badge-primary">Download</span>
                           </li>
                        </ul>
                     </div>
                     <div class="alert alert-warning bg-warning text-white border-0" role="alert">
                        Info: Pengisian rencana akan otomatis terisi, jika laporan kinerja pada semester tersebut sudah divalidasi
                     </div>
                     <div class="card">
                        <div class="card-body">
                           <div class="row mb-2">
