...
if (isset($_POST['proses-pendidikan'])) {
   ...
   @$id = $_POST['id'];
   if ($control == "add") {
      $sql =  mysqli_query($koneksi, "INSERT INTO pendidikan_formal (nik, jenjang, gelar, perguruan_tinggi, fakultas, program_studi, tahun_masuk, tahun_lulus)VALUES('$nik','$jenjang','$gelar','$perguruan_tinggi','$fakultas','$prodi','$tahun_masuk','$tahun_lulus')");
   } else if ($control == "delete") {
      $sql = mysqli_query($koneksi, "DELETE FROM pendidikan_formal WHERE id='$id' ");
   }
   if ($sql) {
   ...
   $_SESSION['redirectlogin'] = 'module/user/pendidikan-formal';
}

if (isset($_POST['upload-pendidikan'])) {
   $tipe = "Ijazah";
   $nik = $_POST['nik'];
