...
if (isset($_POST['proses-inpassing'])) {
   ...
   @$id = $_POST['id'];
   if ($control == "add") {
      $sql =  mysqli_query($koneksi, "INSERT INTO inpasing (nik, pangkat, golongan, nomor_sk, tanggal_sk, terhitung_mulai)VALUES('$nik','$pangkat','$golongan','$nomor_sk','$tanggal_sk','$terhitung_mulai')");
   ...
   $_SESSION['redirectlogin'] = 'module/user/inpassing';
}

if (isset($_POST['upload-inpassing'])) {
   $tipe = "Inpasing";
   $nik = $_POST['nik'];
